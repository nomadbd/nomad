    ...
    <div className="bg-zinc-900 border border-zinc-800 w-full mb-8 rounded-xl overflow-hidden shadow-lg">
      ...
      <div className="p-6">
        ...
        <p className="text-zinc-400 text-sm leading-relaxed mb-6">
          {isExpanded ? bio : (bio?.length > 100 ? `${bio.substring(0, 100)}...` : bio)}
          {bio?.length > 100 && (
            <span onClick={() => setIsExpanded(!isExpanded)} className="text-white font-bold cursor-pointer ml-1 hover:underline">
