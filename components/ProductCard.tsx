  ...
  return (
    <div className="bg-zinc-900 rounded-2xl overflow-hidden border border-zinc-800 flex flex-col h-full">
      ...
      <div className="p-4 flex flex-col flex-grow">
        ...
        {/* প্রাইস এবং বাটন পাশাপাশি */}
        <div className="flex items-center justify-between mt-auto pt-4">
          <span className="text-white text-xs font-bold">{price} BDT</span>
          <button 
            onClick={onDetailsClick}
            className="bg-white text-black text-[10px] font-bold px-4 py-1.5 rounded-full hover:bg-zinc-200 transition"
          >
            DETAILS
          </button>
        </div>
