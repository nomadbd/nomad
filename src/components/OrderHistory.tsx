            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '10px' }}>
              {[1, 2, 3, 4].map((dot) => (
                <div key={dot} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '8px', flex: 1 }}>
                  <div className="skeleton-pulse" style={{ width: '14px', height: '14px', borderRadius: '50%', backgroundColor: '#1c1c1c' }} />
                  <div className="skeleton-pulse" style={{ width: '45px', height: '8px', backgroundColor: '#1c1c1c' }} />
                </div>
              ))}
            </div>
          </div>
