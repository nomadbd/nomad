...
export default function ProfileSettings({
  ...
  // Dynamic Save Button Active State
  ...
  return (
    <div style={{ width: '100%', backgroundColor: '#000000', minHeight: '100%' }}>
      ...
      {/* SECURITY & ACTIONS */}
      <div style={{ borderTop: '1px solid #1C1C1E', paddingTop: '16px', display: 'flex', flexDirection: 'column', gap: '8px', paddingBottom: '40px' }}>
        <div>
          <button 
            type="button"
            onClick={() => {
