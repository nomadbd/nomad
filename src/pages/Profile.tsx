        ...
        {view === 'profile' ? (
          <>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '40px' }}>
              <h2 style={{ letterSpacing: '4px', fontWeight: '100', fontSize: '18px', margin: 0 }}>
            ...
            {/* যদি নাম না থাকে তবে এখানে ক্লিক করে আপডেট করার সুযোগ */}
            {!profile?.name && (
              <div style={{ marginBottom: '15px' }}>
                <p style={{ fontSize: '12px', color: '#888', cursor: 'pointer', textDecoration: 'underline' }} onClick={() => setView('settings')}>Add your name</p>
              </div>
            )}
