        ...
        {view === 'profile' ? (
          <>
            ...
            <div style={{ marginBottom: '20px' }}>
              {profile?.name ? (
                <p style={{ fontSize: '16px', fontWeight: '300', margin: '0' }}>{profile.name}</p>
              ) : (
                <p style={{ fontSize: '14px', color: '#888', cursor: 'pointer', margin: '0' }} onClick={() => setView('settings')}>Add your name</p>
              )}
            </div>
